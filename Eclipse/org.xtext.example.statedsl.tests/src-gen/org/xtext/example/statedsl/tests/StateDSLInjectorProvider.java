...
public class StateDSLInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new StateDSLStandaloneSetup() {
			@Override
	...
	protected StateDSLRuntimeModule createRuntimeModule() {
		...
		return new StateDSLRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return StateDSLInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
